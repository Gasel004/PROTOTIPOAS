  ...
  return (
    <div className="animate-fade-in-up dashboard-page dashboard-productor-page">
      ...
      <div className="dashboard-kpi-grid">
        ...
        <div className="stagger-item"><StatCard icon={<TrendingUp size={22}/>} label="Ingresos este mes" value={`Q${Number(stats?.ingresos_mes ?? 0).toLocaleString()}`} color="cielo" onClick={() => navigate('/pagos')} /></div>
      </div>
