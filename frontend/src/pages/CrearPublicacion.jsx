...
export default function CrearPublicacion() {
  ...
  const { id }        = useParams();  // si tiene id → modo edición
  ...
  const [form,      setForm]      = useState({
    ...
    municipio:'', departamento:'', fecha_cosecha:'', imagen_url:'',
  });
  ...
  function handleChange(e) {
    ...
    // auto-fill unidad al seleccionar producto
    if (name === 'producto_id') {
  ...
  return (
    <div className="animate-fade-in-up" style={{ maxWidth:760, margin:'0 auto' }}>
      <div className="page-header">
        <div>
          <h1>{esEdicion ? '✏️ Editar publicación' : '➕ Nueva publicación'}</h1>
          ...
          <div className="card-body">
            <div className="grid-2">
              <div className="form-group">
                ...
                <p className="form-hint">Fecha estimada o real de cosecha del producto</p>
              </div>
              <div className="form-group">
